...
export type ScopeEntry = { name: string; path: string; directory: boolean; selectable?: boolean };
export type ScopeStatus = { state: "same" | "different" | "remote-only" | "unknown"; detail: string };
