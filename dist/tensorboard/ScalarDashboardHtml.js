...
(function(){
  ...
  function renderHoverDetails(card,entries){
    ...
    const seedValues=entries.map(entry=>Object.entries(entry.seeds||{}).map(([seed,value])=>seed+':'+Number(value).toPrecision(4)).join(' · '));
