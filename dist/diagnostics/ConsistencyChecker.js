...
exports.checkClusterConsistency = checkClusterConsistency;
function checkClusterConsistency(input) {
    const issues = [];
    ...
    for (const record of input.records || []) {
        ...
        if (["delete_requested", "deleting", "delete_failed", "deleted"].includes(state))
            continue;
