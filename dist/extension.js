...
const SshTransportIdentity_1 = require("./tunnel/SshTransportIdentity");
...
class RealtimeTunnelPanelProvider {
    ...
    lastAvailabilityGpuSignature = "";
    gpuHistoryState = new GpuHistoryState_1.GpuHistoryStateCache();
    auditTail;
    debugBundlePath;
    actionErrors = [];
    ...
    async persistCoalescedProjectState(queue, snapshot, write) {
        queue.dirty = true;
    ...
    queueProjectStatePersistence(queue, snapshot, write) {
    ...
    localWorkerAvailabilityRows(ttlSeconds) {
    ...
    async applyTopologyRuntimeMode(mode, reason) {
...
function realtimeUiTopLevelSignature(value) {
