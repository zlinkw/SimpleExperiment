...
test("mobaxterm integration check produces layered report", async () => {
  ...
  try {
    const result = await new MobaXtermIntegration({ configuredPath: exe }).runIntegrationCheck(config);
